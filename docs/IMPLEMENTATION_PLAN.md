...
- [x] PIN-based offline auth (SHA-256 hash stored in Room) — **Note**: Consider upgrading to bcrypt/argon2
...
- [x] Room query optimization (indices on tenantId, outletId, status, categoryId, saleId)
